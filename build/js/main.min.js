...
exports.fixCards = void 0;
var fixCards = function fixCards() {
  if (document.querySelector('[data-hover="card"]')) {
    ...
    cards.forEach(function (card) {
      var innerCard = card.querySelector('[data-hover="inner"]');
...
var _fixCards = require("./fixCards");
// ---------------------------------
...
},{"./fixCards":1,"./modules/form-validate/form":4,"./modules/modals/init-modals":10,"./modules/tabs/init-tabs":12,"./sliders":14,"./utils/ios-vh-fix":17,"./video":19}],3:[function(require,module,exports){
"use strict";
...
var initSliders = function initSliders() {
  if (document.querySelector('[data-swiper="trainers"]')) {
    var swiperTrainers = new Swiper('[data-swiper="trainers"]', {
      speed: 400,
      breakpoints: {
        320: {
          slidesPerView: 1
  ...
  if (document.querySelector('[data-swiper="reviews"]')) {
    var swiperReviews = new Swiper('[data-swiper="reviews"]', {
      speed: 400,
      slidesPerView: 1,
      lazyPreloadPrevNext: 1,
      loop: false,
...
var initVideo = function initVideo() {
  if (document.querySelector('[data-video]')) {
    ...
    var image = document.querySelector('[data-video="image"]');
